...
public class SplineController : MonoBehaviour
{
    ...
    {
        GameObject g = Instantiate(m_objToFollow) as GameObject;
        //mSplineInterp = GetComponent(typeof(SplineInterpolator)) as SplineInterpolator;
        mSplineInterp = g.GetComponent<SplineInterpolator>();
	...
	void DisableTransforms()
	{
        ...
        foreach(MeshRenderer r in SplineRoot.GetComponentsInChildren<MeshRenderer>())
        {
            r.enabled = false;
        }
	}
